...
const Blog = () => {
    return (
        <div>
            <div className='my-16'>
                <h1 className='text-center md:text-3xl font-semibold'>Blog</h1>
            </div>
            <div className='bg-white pb-8'>
                <div className=' w-9/12 mx-auto py-3'>
                    <h1 className='text-3xl font-semibold my-8'>When Should We Use Context API ?</h1>
                    <p>The React Context API should be used when you have data or state that needs to be shared across multiple components in your application, regardless of their nesting level in the component tree.
Context provides a way to pass data through the component tree without having to pass props down manually at every level. This can be particularly useful for global data such as the user's authentication status or a theme setting that needs to be accessed by many components in different parts of the application.</p>
                ...
                <div className=' w-9/12 mx-auto py-3'>
                    <h1 className='text-3xl font-semibold my-8'>What is custom hook in React?</h1>
                    <p>A custom hook in React is a JavaScript function that allows you to reuse stateful logic between multiple components. Custom hooks are a way to encapsulate and share logic that would otherwise require duplication across multiple components or be difficult to manage within a single component.
                ...
                <div className=' w-9/12 mx-auto py-3'>
                    <h1 className='text-3xl font-semibold my-8'>What is Use ref?</h1>
                    <p>n React, the useRef hook is used to create a reference to a DOM element or a value that persists across re-renders of the component.
...
One common use case for useRef is to access DOM nodes in your components. For example, if you want to set the focus to a text input field when a component mounts, you can create a ref using useRef and then pass it to the ref attribute of the input field. You can then use the current property of the ref to access the DOM node and call the focus method on it.</p>
                ...
                <div className=' w-9/12 mx-auto py-3'>
                    <h1 className='text-3xl font-semibold my-8'>What is Use memo ?</h1>
                    <p>In React, the useMemo hook is used to memoize the result of a function, so that it only recomputes the result if one of its dependencies has changed.
