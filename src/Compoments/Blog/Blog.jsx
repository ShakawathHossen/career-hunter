        ...
        <div>
            ...
            <div className='bg-white pb-8'>
                <div className=' md:w-9/12 w-10/12 mx-auto md:py-3 py-1'>
                    <h1 className='text-3xl font-semibold md:my-8 my-4 text-sky-600'>When Should We Use Context API ?</h1>
                ...
                <div className=' md:w-9/12 w-10/12 mx-auto md:py-3 py-1'>
                    <h1 className='text-3xl font-semibold md:my-8 my-4 text-sky-600'>What is custom hook in React?</h1>
                ...
                <div className=' md:w-9/12 w-10/12 mx-auto md:py-3 py-1'>
                    <h1 className='text-3xl font-semibold md:my-8 my-4 text-sky-600'>What is Use ref?</h1>
                ...
                <div className='md:w-9/12 w-10/12 mx-auto md:py-3 py-1'>
                    <h1 className='text-3xl font-semibold md:my-8 my-4 text-sky-600'>What is Use memo ?</h1>
