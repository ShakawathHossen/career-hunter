    ...
    return (
        <div className='d-flex flex-row md:w-full w-11/12 mx-auto'>
            <div className='md:my-24'>
                <h1 className='md:text-5xl text-4xl text-center font-bold mb-2 md:leading-tight leading-tight md:mb-5'>Job Category List</h1>
            ...
            <div className='grid md:grid-cols-4 md:gap-10 gap-5 md:mb-20 mb-10'>
                {
